// components/modals/asset-edit-modal.tsx
...
import { Edit, FileImage, FileText, Video, File } from "lucide-react";
...
export function AssetEditModal({ 
  ...
  React.useEffect(() => {
    if (asset) {
      ...
      setType(asset.type);
      setFileSize(asset.fileSize?.toString() || "");
      setFileUrl(asset.fileUrl || "");
      setAddedBy(asset.addedBy || "");
    }
  }, [asset]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[525px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the details for "{asset.title}". Make your changes below.
          </DialogDescription>
        </DialogHeader>
